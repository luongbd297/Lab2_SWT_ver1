<%-- 
    Document   : ExamScheduleList
    Created on : Nov 2, 2023, 9:54:45 AM
    Author     : 84354
--%>
...
<html lang="en" xml:lang="en">
    <head>
        ...
        <title>Update Exam Schedule</title>
                ...
                <div>
                    ...
                    <form action="admin" method="POST">
                        <table>
                            <tr>
                                <td>ID:</td>
                                <td><input type="text" name="id" value="${e.id}" readonly=""></td>
                            </tr>
                            <tr>
                                <td>Subject:</td>
                                <td>
                            ...
                            <tr>
                                <td>Date:</td>
                                <td><input type="date" name="date" value="${e.date}" class="input-date"></td>
                            </tr>
                            <tr>
                                <td>Location:</td>
                                <td>                                    
                                    <select name="location">
                                        <c:forEach items="${locations}" var="l">
                                            <c:choose>
                                                <c:when test="${l.id eq e.location}">
                                                    <option value="${l.id}" selected>${l.room}, ${l.site}, ${l.cluster}</option>
                                                </c:when>
                                                <c:otherwise>
                                                    <option value="${l.id}">${l.room}, ${l.site}, ${l.cluster}</option>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                    </select>
                            ...
                            <tr>
                                <td>Start Time:</td>
                                <td><input type="time" name="start" value ="${e.start}" class="input-time"></td>
                            </tr>
                            <tr>
                                <td>End Time:</td>
                                <td><input type="time" name="end"  value="${e.end}" class="input-time"></td>
                            </tr>
                            <tr>
                                <td><input type="submit" name="updateExam" value="UPDATE"></td>
