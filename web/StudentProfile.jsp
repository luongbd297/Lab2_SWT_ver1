<%-- 
    ...
    Created on : Nov 10, 2023, 4:42:33 AM
    Author     : 84354
--%>
                ...
                <div>
                    ...
                    <form action="student" method="POST">
                        <table>
                            ...
                            <tr>
                                <td>Phone:</td>
                                <td><input type="text" name="phone" value="${user.phone}" class="input-text"></td>
                            </tr>
                            <tr>
                                <td>Email:</td>
                                <td><input type="text" name="email" value="${user.email}" class="input-text"></td>
                            </tr>                            
                            <tr>
                                <td>Address: </td>
                                <td><input type="text" name="address" value="${user.address}" class="input-text"></td>
                            </tr>
                            </tr>                           
                            <tr>
                                <td>Role: </td>
                                <td><input type="text" name="role" value="${user.role}" class="input-text" readonly></td>
                            </tr>
                            <tr>
