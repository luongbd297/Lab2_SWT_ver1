    ...
    <section class="page-content">
        ...
        <section class="grid">
            <article class="create-exam">
                <div>
                    <h2>Create new Exam Schedule</h2>
                    <form action="admin" method="POST">
                        <table>
                            ...
                            <tr>
                                <td>Date:</td>
                                <td><input type="date" name="date" class="input-date"></td>
                            </tr>
                            <tr>
                                <td>Location:</td>
                                <td>                                    
                            ...
                            <tr>
                                <td>Start Time:</td>
                                <td><input type="time" name="start" class="input-time"></td>
                            </tr>
                            <tr>
                                <td>End Time:</td>
                                <td><input type="time" name="end" class="input-time"></td>
                            </tr>
                            <tr>
                                <td><input type="submit" name="createExam" value="CREATE"></td>
                ...
                <div>
                    <table class="list">
                        ...
                        <c:forEach items="${exams}" var="exam">
                            <tr>
                                <td><a href="admin?mod=1&action=1&id=${exam.id}" class="btn-delete">${exam.id}</a></td>
                                <td>${exam.subject}</td>
                                <td>${exam.date}</td>
                                <td>${exam.location}</td>
                                <td>${exam.start}</td>
                                <td>${exam.end}</td>
                                <td>
                                    <a href="admin?mod=1&action=1&id=${exam.id}" class="btn-delete">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="admin?mod=1&action=2&id=${exam.id}" class="btn-delete">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
